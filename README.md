...
* <https://github.com/spectralops/teller> ⭐ 3,231 | 🐛 52 | 🌐 Rust | 📅 2026-01-27 - secrets management tool for developers, integrate Vault with any other secret and key store
...
* <https://github.com/Lingrino/vaku> ⭐ 160 | 🐛 2 | 🌐 Go | 📅 2026-09-21 - Vaku is a CLI and Go API that extends the official Vault CLI and API with useful high-level functions such as the ability to copy, move, and search vault paths and folders.
...
* <https://github.com/postfinance/vault-kubernetes> ⭐ 79 | 🐛 8 | 🌐 Go | 📅 2026-09-07 - Authenticate services to @hashicorp Vault via the Kubernetes auth method.
